const appLeav = (leaveType, fromDate, toDate, subject, description) => (
...
<div style="font-family: inherit; text-align: center"><span style="font-size: 46px; color: #ffffff; font-family: &quot;trebuchet ms&quot;, helvetica, sans-serif"><strong>Leave</strong></span></div><div></div></div></td>
      </tr>
    </tbody>
  ...
  <![endif]--><table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="efe5a2c4-1b11-49e7-889d-856d80b40f63.2" data-mc-module-version="2019-10-22">
    <tbody>
      <tr>
        <td style="padding:50px 30px 30px 30px; line-height:28px; text-align:inherit; background-color:#7205a4;" height="100%" valign="top" bgcolor="#7205a4" role="module-content"><div><div style="font-family: inherit; text-align: justify"><span style="color: #ffffff">Type of Leave:-</span></div>
<div style="font-family: inherit; text-align: left"><span style="color: #ffffff">To:- &nbsp;&nbsp;From:-</span></div>
<div style="font-family: inherit; text-align: left"><span style="color: #ffffff">Subject:-</span></div>
<div style="font-family: inherit; text-align: justify"><span style="color: #ffffff">Description:-</span></div><div></div></div></td>
      </tr>
    </tbody>
  </table><!--[if (gte mso 9)|(IE)]>
          </td>
